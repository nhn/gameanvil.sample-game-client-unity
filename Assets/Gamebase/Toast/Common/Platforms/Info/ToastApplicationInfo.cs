...
namespace Toast.Internal
{
    public static class ToastApplicationInfo
    {
        ...
        [DllImport("ToastCommon")]
        private static extern System.IntPtr GetAuditProjectKey(bool bReal);
        [DllImport("ToastCommon")]
        private static extern System.IntPtr GetEncryptionKey();
        ...
        {
            string encryptionKey = "C6B15A622C2FE2CD914F58A47A2FF";
#if UNITY_STANDALONE_WIN
            IntPtr p = GetEncryptionKey();
            encryptionKey = Marshal.PtrToStringAnsi(p);
#elif UNITY_STANDALONE_OSX
        ...
        public static string GetAuditKey()
        {
            string projectKey = "";
#if UNITY_STANDALONE_WIN
            IntPtr p = GetAuditProjectKey(true);
            projectKey = Marshal.PtrToStringAnsi(p);
#elif UNITY_STANDALONE_OSX
            IntPtr p = GetAuditProjectKey(true);
            projectKey = Marshal.PtrToStringAnsi(p);
#elif UNITY_STANDALONE_LINUX
